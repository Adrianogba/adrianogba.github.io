...
class ContactItem extends StatelessWidget {
  ...
  const ContactItem({super.key, required this.icon, required this.text, this.url, this.onTap})
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [BoxShadow(color: Colors.black.withValues(alpha: 0.1), blurRadius: 4, spreadRadius: 0.5, offset: const Offset(0, 1))],
        ),
        child: Row(
