...
class EducationCard extends StatelessWidget {
  ...
  const EducationCard({super.key, required this.degree, required this.institution, this.institutionUrl, required this.period, this.description});
        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                Expanded(
                  child: Text(degree, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                ),
                Container(
